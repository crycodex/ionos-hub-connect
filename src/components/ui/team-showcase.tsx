  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5">
        ...
        <span
          className={cn(
            "text-sm md:text-base font-semibold leading-none tracking-tight transition-colors duration-300",
      ...
      {member.expertise && (
        <p className="mt-1 pl-[27px] text-[11px] md:text-xs leading-snug text-muted-foreground/80 max-w-md">
          {member.expertise}
        </p>
      )}
    </div>
